pipeline {
    environment {  DOCKERHUB_CREDENTIALS=credentials('usera20_mezghichdokub') }
    agent any 
    ...
    stages {
        ...
        stage('tag and push image to dockerhub') {
                    ...
                    sh "docker tag mezghich_ams_2024 mezghichdokub/mezghich_ams_2024"

                    sh "docker login -u $DOCKERHUB_CREDENTIALS_USR -p      $DOCKERHUB_CREDENTIALS_PSW"

                    sh "docker push mezghichdokub/mezghich_ams_2024"
